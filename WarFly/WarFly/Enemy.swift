...
class Enemy: SKSpriteNode {
    ...
    init(enemyTexture: SKTexture) {
        ...
        self.physicsBody?.contactTestBitMask = BitMaskCategory.player.rawValue | BitMaskCategory.player.rawValue
    }
    ...
    func flySpiral() {
        ...
        let asideMovementSequence = randomNumber == EnemyDirection.left.rawValue ? SKAction.sequence([moveLeft, moveRight]) :
